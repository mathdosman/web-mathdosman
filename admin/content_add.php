                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="form-text">Daftar materi belum tersedia. Tambahkan materi di menu Mapel.</div>
                                <?php endif; ?>
                            </div>
                        ...
                        (function () {
                            ...
                            function applyFilter() {
                                ...
                                opts.forEach(function (opt) {
                                    ...
                                    // If materi is not chosen, show all.
                                ...
                                // If selected option becomes hidden, reset to empty.
